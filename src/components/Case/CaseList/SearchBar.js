        ...
        <div className="searchBar">
          <Form layout="inline">
            <Row>
              ...
              <FormItem label="状态">
                <Select value={search.treatmentStatus11} onChange={this.handleChange('treatmentStatus11')} placeholder="请选择" >
                  {treatmentStatus.map(({ label, value }) => (<Option key={value} value={value}>{label}</Option>))}
                </Select>
              </FormItem>
              <FormItem label="日期">
              ...
              <FormItem label="初／复诊">
                <Select value={search.treatmentStatus22} onChange={this.handleChange('treatmentStatus22')} placeholder="请选择" >
                  {treatmentStatus.map(({ label, value }) => (<Option key={value} value={value}>{label}</Option>))}
                </Select>
              </FormItem>
              <FormItem label="诊疗项目">
